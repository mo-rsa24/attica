...
export default function ListingStep4() {
    ...
    const { eventDetails, setEventDetails } = useEventCreation(); // Assuming context provides this
        ...
        <div className="bg-white min-h-screen font-sans flex flex-col">
            <header className="fixed top-0 left-0 right-0 bg-white z-20">
                 <div className="flex items-center justify-between p-6">
                    ...
                    <div className="flex items-center space-x-4"><button className="px-4 py-2 text-sm font-semibold text-gray-800 bg-gray-100 rounded-full hover:bg-gray-200">Save & exit</button></div>
                </div>
            </header>
            ...
            <footer className="fixed bottom-0 left-0 right-0 bg-white z-20">
                ...
                <div className="flex items-center justify-between p-4">
                    <button onClick={() => navigate('/listing/step3')} className="font-semibold text-gray-800 underline hover:text-black">Back</button>
                    <button
                        onClick={handleNext}
